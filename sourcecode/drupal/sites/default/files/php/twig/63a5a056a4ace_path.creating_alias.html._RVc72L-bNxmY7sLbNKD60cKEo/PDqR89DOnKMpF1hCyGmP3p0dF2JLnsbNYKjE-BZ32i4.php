...
class __TwigTemplate_66006c9913a81e5ca6c2d5743f3fdcd3 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 12
        $context["path_permissions_link"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["path_permissions_link_text"] ?? null), 12, $this->source), "user.admin_permissions.module", ["modules" => "path"]));
        // line 13
        $context["overview_topic"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getTopicLink("path.overview"));
        // line 14
        echo "<h2>";
        echo t("Goal", array());
        echo "</h2>
...
<ul>
  <li><a href=\"https://www.drupal.org/docs/user_guide/en/content-create.html\">";
    ...
    {
        return new Source("", "@help_topics/path.creating_alias.html.twig", "C:\\xampp\\htdocs\\drupal\\core\\modules\\help_topics\\help_topics\\path.creating_alias.html.twig");
    }
