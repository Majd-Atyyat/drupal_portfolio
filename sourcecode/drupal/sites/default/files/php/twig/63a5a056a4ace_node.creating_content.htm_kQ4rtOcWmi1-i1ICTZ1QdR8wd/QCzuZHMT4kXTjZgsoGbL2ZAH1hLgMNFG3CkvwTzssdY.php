...
class __TwigTemplate_5f78b0d7f5f87d1f8bfd7246dd0f6934 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 11
        $context["content_link"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["content_link_text"] ?? null), 11, $this->source), "system.admin_content"));
        // line 12
        ob_start(function () { return ''; });
        // line 13
        echo "  ";
        ...
        // line 15
        $context["content_permissions_link"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["content_permissions_link_text"] ?? null), 15, $this->source), "user.admin_permissions.module", ["modules" => "node"]));
        // line 16
...
<ul>
  <li><a href=\"https://www.drupal.org/docs/user_guide/en/content-chapter.html\">";
        // line 34
        echo t("User Guide: Basic page management", array());
        echo "</a></li>
  <li><a href=\"https://www.drupal.org/docs/user_guide/en/content-create.html\">";
        // line 35
        echo t("User Guide: Creating a content item", array());
        echo "</a></li>
</ul>";
    }
    ...
    {
        return new Source("", "@help_topics/node.creating_content.html.twig", "C:\\xampp\\htdocs\\drupal\\core\\modules\\help_topics\\help_topics\\node.creating_content.html.twig");
    }
