...
class __TwigTemplate_040e7eaa42864af1c324c362d1930921 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 8
        $context["languages_link"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["languages_text"] ?? null), 8, $this->source), "entity.configurable_language.collection"));
        // line 9
        echo "<h2>";
        echo t("Goal", array());
        echo "</h2>
...
<ol>
  <li>";
        // line 13
        echo t("In the <em>Manage</em> administrative menu, navigate to <em>Configuration</em> &gt; <em>Regional and language</em> &gt; @languages_link.", array("@languages_link" => ($context["languages_link"] ?? null), ));
        echo "</li>
  <li>";
        // line 14
  ...
  <li>";
    ...
    {
        return new Source("", "@help_topics/language.add.html.twig", "C:\\xampp\\htdocs\\drupal\\core\\modules\\help_topics\\help_topics\\language.add.html.twig");
    }
