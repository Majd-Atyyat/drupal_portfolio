...
class __TwigTemplate_3ad6ec153ad99dfb31c1fd6ff10d04ca extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 10
        $context["language_link"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["language_text"] ?? null), 10, $this->source), "entity.configurable_language.collection"));
        // line 11
        $context["translation_updates_link"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["translation_updates_text"] ?? null), 11, $this->source), "locale.translate_status"));
        // line 12
        echo "<h2>";
        echo t("Goal", array());
        echo "</h2>
...
<ol>
  <li>";
        // line 16
        echo t("In the <em>Manage</em> administrative menu, navigate to <em>Configuration</em> &gt; <em>Regional and language</em> &gt; @language_link.", array("@language_link" => ($context["language_link"] ?? null), ));
        echo "</li>
  <li>";
        // line 17
  ...
  <li>";
    ...
    {
        return new Source("", "@help_topics/locale.translation_status.html.twig", "C:\\xampp\\htdocs\\drupal\\core\\modules\\help_topics\\help_topics\\locale.translation_status.html.twig");
    }
