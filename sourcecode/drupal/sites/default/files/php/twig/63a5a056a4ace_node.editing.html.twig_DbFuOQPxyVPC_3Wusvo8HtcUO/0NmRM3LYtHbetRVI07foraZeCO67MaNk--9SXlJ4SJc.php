...
class __TwigTemplate_cff9f460283743dc507150fb695b58ff extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 10
        $context["content_link"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["content_link_text"] ?? null), 10, $this->source), "system.admin_content"));
        // line 11
        ob_start(function () { return ''; });
        // line 12
        echo "  ";
        ...
        // line 14
        $context["content_permissions_link"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["content_permissions_link_text"] ?? null), 14, $this->source), "user.admin_permissions.module", ["modules" => "node"]));
        // line 15
        $context["node_overview_topic"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getTopicLink("node.overview"));
        // line 16
        echo "<h2>";
        echo t("Goal", array());
        echo "</h2>
...
<ul>
  ...
  <li><a href=\"https://www.drupal.org/docs/user_guide/en/content-edit.html\">";
        // line 38
        echo t("User Guide: Editing a content item", array());
        echo "</a></li>
</ul>";
    }
    ...
    {
        return new Source("", "@help_topics/node.editing.html.twig", "C:\\xampp\\htdocs\\drupal\\core\\modules\\help_topics\\help_topics\\node.editing.html.twig");
    }
