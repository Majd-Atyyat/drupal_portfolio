...
class __TwigTemplate_a9d5f414d277f6a8aafddcca7ff5f0fa extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 13
        $context["content_permissions_link"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["content_permissions_link_text"] ?? null), 13, $this->source), "user.admin_permissions.module", ["modules" => "node"]));
        // line 14
        ob_start(function () { return ''; });
        // line 15
        echo "  ";
        ...
        // line 17
        $context["content_types_link"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["content_types_link_text"] ?? null), 17, $this->source), "entity.node_type.collection"));
        // line 18
        $context["content_overview_topic"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getTopicLink("node.overview"));
        // line 19
        echo "<h2>";
        echo t("Goal", array());
        echo "</h2>
...
<ul>
  <li><a href=\"https://www.drupal.org/docs/user_guide/en/structure-content-type.html\">";
        // line 34
        echo t("User Guide: Adding a content type", array());
        echo "</a></li>
  <li><a href=\"https://www.drupal.org/docs/user_guide/en/content-structure-chapter.html\">";
        // line 35
        echo t("User Guide: Setting up content structure", array());
        echo "</a></li>
</ul>";
    }
    ...
    {
        return new Source("", "@help_topics/node.creating_type.html.twig", "C:\\xampp\\htdocs\\drupal\\core\\modules\\help_topics\\help_topics\\node.creating_type.html.twig");
    }
