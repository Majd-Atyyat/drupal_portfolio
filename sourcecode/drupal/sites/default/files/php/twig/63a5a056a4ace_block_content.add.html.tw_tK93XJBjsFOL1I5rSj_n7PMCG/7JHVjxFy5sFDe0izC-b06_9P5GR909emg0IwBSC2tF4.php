...
class __TwigTemplate_c821dbf86e9863b22a19c707d302010f extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo t("Custom block library", array());
        $context["library_link_text"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        // line 10
        $context["library_link"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["library_link_text"] ?? null), 10, $this->source), "entity.block_content.collection"));
        // line 11
        echo "<h2>";
        echo t("Goal", array());
        echo "</h2>
...
<ol>
  <li>";
        // line 15
        echo t("In the <em>Manage</em> administrative menu, navigate to <em>Structure</em> &gt; <em>Block layout</em> &gt; @library_link.", array("@library_link" => ($context["library_link"] ?? null), ));
        echo "</li>
  <li>";
        // line 16
  ...
  <li>";
    ...
    {
        return new Source("", "@help_topics/block_content.add.html.twig", "C:\\xampp\\htdocs\\drupal\\core\\modules\\help_topics\\help_topics\\block_content.add.html.twig");
    }
