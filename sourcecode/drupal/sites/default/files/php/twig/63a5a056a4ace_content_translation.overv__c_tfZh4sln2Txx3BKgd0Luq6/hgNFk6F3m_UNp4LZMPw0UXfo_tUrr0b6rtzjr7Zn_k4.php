...
class __TwigTemplate_0596b094fa74587361ca59d36b58ea6f extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 8
        $context["translation_settings_link"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["translation_settings_link_text"] ?? null), 8, $this->source), "language.content_settings_page"));
        // line 9
...
<ol>
  <li>";
        // line 14
        echo t("In the <em>Manage</em> administrative menu, navigate to <em>Configuration</em> &gt; <em>Regional and language</em> &gt; <em>@translation_settings_link</em>.", array("@translation_settings_link" => ($context["translation_settings_link"] ?? null), ));
        echo "</li>
  <li>";
        // line 15
  ...
  <li>";
    ...
    {
        return new Source("", "@help_topics/content_translation.overview.html.twig", "C:\\xampp\\htdocs\\drupal\\core\\modules\\help_topics\\help_topics\\content_translation.overview.html.twig");
    }
