...
class __TwigTemplate_b862a8f69fbfb291ecb0881dcb9aa84b extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 8
        $context["config_link"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["config_link_text"] ?? null), 8, $this->source), "entity.user.admin_form"));
        // line 9
        ob_start(function () { return ''; });
        echo t("Permissions", array());
        $context["permission_link_text"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        // line 10
        $context["permission_link"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["permission_link_text"] ?? null), 10, $this->source), "user.admin_permissions"));
        // line 11
...
<ol>
  ...
  <li>";
    ...
    {
        return new Source("", "@help_topics/contact.configuring_personal.html.twig", "C:\\xampp\\htdocs\\drupal\\core\\modules\\help_topics\\help_topics\\contact.configuring_personal.html.twig");
    }
