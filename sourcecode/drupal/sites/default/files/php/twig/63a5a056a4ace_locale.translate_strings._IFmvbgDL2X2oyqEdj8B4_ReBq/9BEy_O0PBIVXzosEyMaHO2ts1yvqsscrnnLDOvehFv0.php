...
class __TwigTemplate_7e5db8497deca4032629be71a13f584e extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 10
        $context["translate_link"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["translate_text"] ?? null), 10, $this->source), "locale.translate_page"));
        // line 11
        echo "<h2>";
        echo t("Goal", array());
        echo "</h2>
...
<ol>
  <li>";
        // line 15
        echo t("In the <em>Manage</em> administrative menu, navigate to <em>Configuration</em> &gt; <em>Regional and language</em> &gt; @translate_link.", array("@translate_link" => ($context["translate_link"] ?? null), ));
        echo "</li>
  <li>";
        // line 16
  ...
  <li>";
    ...
    {
        return new Source("", "@help_topics/locale.translate_strings.html.twig", "C:\\xampp\\htdocs\\drupal\\core\\modules\\help_topics\\help_topics\\locale.translate_strings.html.twig");
    }
