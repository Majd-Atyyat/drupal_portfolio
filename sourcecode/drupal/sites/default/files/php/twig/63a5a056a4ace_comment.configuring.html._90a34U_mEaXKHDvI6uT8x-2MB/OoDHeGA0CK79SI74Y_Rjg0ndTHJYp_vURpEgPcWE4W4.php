...
class __TwigTemplate_8c65d51950f0eaaef26a3934bea5406f extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 12
        $context["comment_permissions_link"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["comment_permissions_link_text"] ?? null), 12, $this->source), "user.admin_permissions.module", ["modules" => "comment"]));
        // line 13
        ...
        // line 14
        $context["comment_type_topic"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getTopicLink("comment.creating_type"));
        // line 15
        echo "<h2>";
        echo t("Goal", array());
        echo "</h2>
...
<ul>
  <li><a href=\"https://www.drupal.org/docs/8/core/modules/comment/administering-a-content-types-comment-settings\">";
    ...
    {
        return new Source("", "@help_topics/comment.configuring.html.twig", "C:\\xampp\\htdocs\\drupal\\core\\modules\\help_topics\\help_topics\\comment.configuring.html.twig");
    }
