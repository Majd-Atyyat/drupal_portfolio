...
class __TwigTemplate_9b70ea4abd632c1237231cf3c0deef64 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<ul>
  <li>";
        // line 46
        echo t("<a href=\"https://www.drupal.org/docs/8/configuration-management/workflow-using-drush\">Configuration management: Workflow using Drush</a>", array());
        echo "</li>
  <li>";
        // line 47
        echo t("<a href=\"https://www.drupal.org/docs/user_guide/en/understanding-data.html\">Concept: Types of Data article in the Drupal User Guide</a>", array());
        echo "</li>
  <li>";
        // line 48
        echo t("<a href=\"https://www.drupal.org/docs/user_guide/en/install-dev-sites.html\">Concept: Development Sites article in the Drupal User Guide</a>", array());
        echo "</li>
  <li>";
        // line 49
        echo t("<a href=\"https://www.drupal.org/docs/user_guide/en/install-dev-making.html\">Making a Development Site article in the Drupal User Guide</a>", array());
        echo "</li>
</ul>";
    }
    ...
    {
        return new Source("", "@help_topics/core.config_overview.html.twig", "C:\\xampp\\htdocs\\drupal\\core\\modules\\help_topics\\help_topics\\core.config_overview.html.twig");
    }
