...
class __TwigTemplate_d49c155f12c31c8d8646593eb251e633 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 8
        $context["detection_link"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["detection_text"] ?? null), 8, $this->source), "language.negotiation"));
        // line 9
        echo "<h2>";
        echo t("Goal", array());
        echo "</h2>
...
<ol>
    <li>";
        // line 29
        echo t("In the <em>Manage</em> administrative menu, navigate to <em>Configuration</em> &gt; <em>Regional and language</em> &gt; <em>Languages</em> &gt; @detection_link.", array("@detection_link" => ($context["detection_link"] ?? null), ));
        echo "</li>
    <li>";
        // line 30
    ...
    {
        return new Source("", "@help_topics/language.detect.html.twig", "C:\\xampp\\htdocs\\drupal\\core\\modules\\help_topics\\help_topics\\language.detect.html.twig");
    }
