...
class __TwigTemplate_ba713805804fe1cad3534c840a0bcdd1 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 10
        $context["path_permissions_link"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["path_permissions_link_text"] ?? null), 10, $this->source), "user.admin_permissions.module", ["modules" => "path"]));
        // line 11
        ob_start(function () { return ''; });
        // line 12
        echo "  ";
        ...
        // line 14
        $context["path_aliases_link"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["path_aliases_link_text"] ?? null), 14, $this->source), "entity.path_alias.collection"));
        // line 15
        $context["path_overview_topic"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getTopicLink("path.overview"));
        // line 16
        echo "<h2>";
        echo t("Goal", array());
        echo "</h2>
...
<ol>
  ...
  <li>";
    ...
    {
        return new Source("", "@help_topics/path.editing_alias.html.twig", "C:\\xampp\\htdocs\\drupal\\core\\modules\\help_topics\\help_topics\\path.editing_alias.html.twig");
    }
