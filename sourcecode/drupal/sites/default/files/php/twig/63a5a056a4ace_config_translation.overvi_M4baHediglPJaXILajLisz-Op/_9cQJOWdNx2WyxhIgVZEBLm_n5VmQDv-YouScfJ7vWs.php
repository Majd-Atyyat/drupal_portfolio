...
class __TwigTemplate_bcc7f5d04f7ee95f0a24576c3340e773 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 9
        $context["config_translation_link"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["config_translation_link_text"] ?? null), 9, $this->source), "config_translation.mapper_list"));
        // line 10
...
<ol>
  <li>";
        // line 16
        echo t("In the <em>Manage</em> administrative menu, navigate to <em>Configuration</em> &gt; <em>Regional and language</em> &gt; <em>@config_translation_link</em>.", array("@config_translation_link" => ($context["config_translation_link"] ?? null), ));
        echo "</li>
  <li>";
        // line 17
  ...
  <li>";
    ...
    {
        return new Source("", "@help_topics/config_translation.overview.html.twig", "C:\\xampp\\htdocs\\drupal\\core\\modules\\help_topics\\help_topics\\config_translation.overview.html.twig");
    }
