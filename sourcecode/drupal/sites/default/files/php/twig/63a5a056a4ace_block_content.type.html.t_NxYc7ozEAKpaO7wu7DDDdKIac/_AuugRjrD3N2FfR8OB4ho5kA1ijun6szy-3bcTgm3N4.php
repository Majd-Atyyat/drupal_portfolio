...
class __TwigTemplate_70391a8fdcda3b6d4f3d65c0794e9293 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 13
        $context["types_link"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["types_link_text"] ?? null), 13, $this->source), "entity.block_content_type.collection"));
        // line 14
        echo "<h2>";
        echo t("Goal", array());
        echo "</h2>
...
<ol>
  <li>";
        // line 18
        echo t("In the <em>Manage</em> administrative menu, navigate to <em>Structure</em> &gt; <em>Block layout</em> &gt; <em>Custom block library</em> &gt; <em>@types_link</em>.", array("@types_link" => ($context["types_link"] ?? null), ));
        echo "</li>
  <li>";
        // line 19
  ...
  <li>";
    ...
    {
        return new Source("", "@help_topics/block_content.type.html.twig", "C:\\xampp\\htdocs\\drupal\\core\\modules\\help_topics\\help_topics\\block_content.type.html.twig");
    }
