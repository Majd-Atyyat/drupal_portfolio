...
class __TwigTemplate_eee777d76d0ac3d714ad9ce8012d4e05 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 11
        $context["comment_unpublished_link"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["comment_unpublished_link_text"] ?? null), 11, $this->source), "comment.admin_approval"));
        // line 12
        ob_start(function () { return ''; });
        // line 13
        echo "  ";
        ...
        // line 15
        $context["comment_published_link"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["comment_published_link_text"] ?? null), 15, $this->source), "comment.admin"));
        // line 16
        ob_start(function () { return ''; });
        // line 17
        echo "  ";
        ...
        // line 19
        $context["comment_permissions_link"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["comment_permissions_link_text"] ?? null), 19, $this->source), "user.admin_permissions.module", ["modules" => "comment"]));
        // line 20
        echo "<h2>";
        echo t("Goal", array());
        echo "</h2>
...
<ul>
  <li><a href=\"https://www.drupal.org/docs/8/core/modules/comment/administering-and-approving-comments\">";
    ...
    {
        return new Source("", "@help_topics/comment.moderating.html.twig", "C:\\xampp\\htdocs\\drupal\\core\\modules\\help_topics\\help_topics\\comment.moderating.html.twig");
    }
